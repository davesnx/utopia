  ...
  $ touch _utopia/dune
  $ cat > app/home/page.ml <<'EOF'
  > let before request = request
  > let makeProps () = ()
  > let make () = React.string "non-static"
  > EOF
  $ utopia.compiler > /dev/null
  $ grep -A 12 -F 'source_file = "app/home/page.ml"' _utopia/Routes.ml | grep -qF 'static = false;'
  $ grep -A 12 -F 'source_file = "app/home/page.ml"' _utopia/Routes.ml | grep -qF 'has_paths = false'
