  ...
  let about__team_router_tree () =
    Utopia.Router.Boundary.make ~path:"/" ~layout:(Utopia.PassThroughLayout.make ~children:(Utopia.Router.Boundary.PageConsumer.make ()) ()) ~pageconsumer:(Some (Utopia.Router.Boundary.make ~path:"/about" ~layout:(Utopia.PassThroughLayout.make ~children:(Utopia.Router.Boundary.PageConsumer.make ()) ()) ~pageconsumer:(Some (Utopia.Router.Boundary.make ~path:"/about/team" ~layout:(Utopia_server.wrap_raw_inner_html_element (Utopia_page__About__Team.make ())) ~pageconsumer:None ())) ())) ()
    Utopia.make ~initialPath:location ~children:(about__team_router_tree ()) ()
    | "/" -> Some (Utopia.Router.Boundary.make ~path:"/about" ~layout:(Utopia.PassThroughLayout.make ~children:(Utopia.Router.Boundary.PageConsumer.make ()) ()) ~pageconsumer:(Some (Utopia.Router.Boundary.make ~path:"/about/team" ~layout:(Utopia_server.wrap_raw_inner_html_element (Utopia_page__About__Team.make ())) ~pageconsumer:None ())) ())
    | "/about" -> Some (Utopia.Router.Boundary.make ~path:"/about/team" ~layout:(Utopia_server.wrap_raw_inner_html_element (Utopia_page__About__Team.make ())) ~pageconsumer:None ())
    ...
    Utopia_server.Generated_route.code ~route:"about/team" ~matcher:"about/team" ~params:[] ~source_file:"pages/about/Team.re" ~layouts:[] ~render:(fun () -> Utopia_server.wrap_raw_inner_html_element (Utopia_page__About__Team.make ())) ~metadata:None ~layout_renderers:[] ~router_shell:about__team_router_shell ~router_tree:about__team_router_tree ~router_subtree:about__team_router_subtree;
    Utopia_server.Generated_route.markdown ~route:"guide" ~matcher:"guide" ~params:[] ~source_file:"pages/Guide.md" ~layouts:[]  ~metadata:None ~layout_renderers:[] ~router_shell:guide_router_shell ~router_tree:guide_router_tree ~router_subtree:guide_router_subtree;
